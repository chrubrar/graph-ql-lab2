    ...
    <article className="max-w-5xl mx-auto text-white">
      <section className="flex gap-2 ">
        ...
        <div className="p-2 flex flex-col">
          <h1 className="text-4xl ">Hello Title : {novel.title}</h1>
          ...
          <form onSubmit={handleAddAuthor} className="mt-5 space-x-2">
            <input
              ...
              className="bg-transparent border p-2 mx-2 text-zinc-700"
            />
            <button
              disabled={!name}
              className="border p-2 rounded-lg text-red-500 disabled:text-blue-500 disabled:cursor-not-allowed"
            >
              Add Author
            </button>
          </form>
      ...
      <form onSubmit={handleUpdateNovel} className="flex gap-2 ">
        <input
          ...
          className="bg-transparent border text-zinc-700 p-2 rounded-lg"
        />
        <input
          value={url}
